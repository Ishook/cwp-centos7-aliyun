...
cd /tmp
rm -fv csf.tgz
wget --no-check-certificate https://raw.githubusercontent.com/Ishook/cwp-centos7-aliyun/master/csf.tgz
tar -xzf csf.tgz
cd csf
sh install.sh
...
wget dl1.centos-webpanel.com/files/cwp/el7/cwp-el7-0.9.8.794.zip
unzip -o -q cwp-el7-0.9.8.794.zip
rm -f cwp-el7-0.9.8.794.zip
...
unzip -o -q phpMyAdmin-4.6.6-all-languages.zip
